 ...
 */
package com.spinages.animation;
 ...
 * location (which creates a cubic  curve from the previous location).
 */
public class AnimatorPath {
    ...
    /**
     * Create a cubic �zier curve from the current path point to the new one
